...
public class MusicManager implements Disposable
{
	...
	public void play(BackgroundMusic music)
	{
		...
		// do some logging
		Gdx.app.log(Invasion.LOG, "Playing music: " + music.getName());
	...
	public void stop()
	{
		...
		{
			Gdx.app.log(Invasion.LOG, "Stopping current music");
	...
	{
		Gdx.app.log(Invasion.LOG, "Adjusting music volume to: " + volume);
	...
	public void dispose()
	{
		Gdx.app.log(Invasion.LOG, "Disposing music manager");
//		stop();
	}
}